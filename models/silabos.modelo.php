...
class SilabosModelo
{
    ...
    static public function mdlAgregarSilabos($id_profesor, $id_materia, $id_horario, $id_periodo, $id_doc, $id_anio, $capel)
    {
        try {
            $conn = Conexion::ConexionDB();
            $stmt = $conn->prepare("INSERT INTO tblasignar (capel, id_profesor, id_materia, id_horario, id_periodo, id_doc, id_temp, fecha_entrega) 
                                        VALUES (:capel, :id_profesor, :id_materia, :id_horario, :id_periodo, :id_doc, :id_anio, CURRENT_DATE)");
