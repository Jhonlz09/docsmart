        ...
        <div class="tab-content " id="tabsContent-asignar-modulos-perfil">
            ...
            <div class="tab-pane fade active show mt-4 px-4" id="content-modulo-perfil" role="tabpanel" aria-labelledby="content-modulo-perfil-tab">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card card-danger card-outline shadow" style="display:none" id="card-permisos">
                    ...
                    <div class="col-md-4">
                        <div class="card card-danger card-outline shadow" style="display:none" id="card-modulos">
                            <div class="card-header card-dark" style="border-bottom: 1px solid rgb(255 255 255 /25%);">
                            ...
                            <div class="card-body card-dark" id="card-body-modulos">
                                <div class="row mb-2">
                                    <div class="col-md-6">
                                        <button class="btn btn-danger btn-small  m-0 p-0 w-100" id="marcar_modulos">Marcar</button>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="select2 select2-danger custom-select" data-dropdown-css-class="select2-danger" id="select_modulos">
                                            </select>
                                        </div>
                                    </div>
                                </div>
