                            ...
                            <div id="colres" class="col-md-6" style="display: flex; justify-content: center;">
                                <div class="row" style="margin:auto; justify-content:space-between">
                                    ...
                                    <div class="custom-control custom-switch mr-2">
                                        ...
                                        <label class="custom-control-label" for="customSwitch4">Pendiente</label>
                                    </div>
                                    <div class="custom-control custom-switch mr-2">
                            ...
                            <div class="row">
                                <div class="col-md-2 pt-0 text-center">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="ckTodo" value="">
                                        <label for="ckTodo" class="custom-control-label">TODO</label>
                                    </div>
                                </div>
                                <div class="col-md-2 pt-0 text-center">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="ckS1M1" value="1">
                                        <label for="ckS1M1" class="custom-control-label">S1 M1</label>
                                    </div>
                                </div>
                                <div class="col-md-2 pt-0 text-center">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="ckS1M2" value="2">
                                        <label for="ckS1M2" class="custom-control-label">S1 M2</label>
                                    </div>
                                </div>
                                <div class="col-md-2 pt-0 text-center">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="ckS2M1" value="3">
                                        <label for="ckS2M1" class="custom-control-label">S2 M1</label>
                                    </div>
                                </div>
                                <div class="col-md-2 pt-0 text-center">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="ckS2M2" value="4">
                                        <label for="ckS2M2" class="custom-control-label">S2 M2 </label>
                                    </div>
                                </div>
                                <div class="col-md-2 pt-0 text-center">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="ckInvierno" value="5">
                                        <label for="ckInvierno" class="custom-control-label">INVIERNO</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div id="obs" class="form-group">
                                ...
                                <div class="invalid-feedback">Seleccione la carrera</div>
                            </div>
                        </div>
                    </div>
                    <br>
        ...
        <div class="modal-content modal-nuevo">
            ...
            <div class="modal-body">
                ...
                <div class="justify-content-between">
                    ...
                    <button id="btnConfirmar" type="button" class="btn btn-success"><i class="fa-solid fa-circle-check"></i></i><span class="button-text"> Confirmar</span></button>
                </div>
            </div>
        </div>
        <!-- /.modal-content -->
...
<script>
    ...
    var secondToggle = toggles[1];
    var thirdToggle = toggles[2];
    var fourthToggle = toggles[3];
    ...
    // Evento que se dispara al realizar una búsqueda en el DataTable
