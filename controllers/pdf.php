...
if ($validacionGrafico == null) {
    ...
    $pdf->Cell(0, 0, 'GUAYAQUIL - ECUADOR', 0, 0, 'C');
...
CELDA ELABORADO POR
    ...
    $pdf->SetXY(20, 210);
    $pdf->Cell(0, 40, iconv('UTF-8', 'windows-1252', 'Esthela E. Benitez R., Mtr'));
    $pdf->SetXY(20, 210);
    $pdf->Cell(0, 50, iconv('UTF-8', 'windows-1252', 'Contraloría Académica'));
...
CELDA APROBADO POR
    ...
    $pdf->SetXY(106, 210);
    $pdf->Cell(0, 40, iconv('UTF-8', 'windows-1252', 'Maritza Salazar Veloz., Msc'));
    $pdf->SetXY(106, 210);
    $pdf->Cell(0, 50, iconv('UTF-8', 'windows-1252', 'Rectora'));
    $pdf->AddPage();
    ...
    $pdf->SetX(20);
    $pdf->Row(array('Direccion de carrera', 'Silabo', 'Micros'), array(12, 12, 12), 'B');
